...
const forgetPassword = async (req,res,next) => {
  ...
  const resetURL = `http://localhost:${process.env.PORT}/api/users/forgetPassword/${resetToken}`;
  const message = `to change your password <a href = "${confirmEmailURL}" target="_blank">Click here</a>`;
  await sendEmail({
    email: req.body.email,
    subject: "Your Account Confirmation",
    html: message,
